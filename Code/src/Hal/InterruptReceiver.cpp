...
void registerInterrupt(int connectionID_Interrupt){
    ...
    SIGEV_PULSE_INIT(&intr_event, connectionID_Interrupt, SIGEV_PULSE_PRIO_INHERIT, PULSE_INTR_ON_PORT0, 0);
...
void enableRisingEdgeDetect(uintptr_t gpio_bank_0){
    ...
    temp |= (E_STOP | BUTTON_START | BUTTON_RESET | BUTTON_STOP | SENSOR_METAL | HIGHT_MEASUREMENT | LSA | LSW | LSR | LSE);//Add desired pins.
    ...
    while (receivingRunning) {
        ...
        switch(msg.code) {
            ...
            case PULSE_INTR_ON_PORT0:
                ...
                MsgSendPulse(connectionID_Encoder, -1, PULSE_INTR_ON_PORT0_MACHINE1,
