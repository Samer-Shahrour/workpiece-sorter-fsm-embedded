...
void FSM_Thread(int channelID_FSM, int connectionID_FSM, int connectionID_Dispatcher){
    ...
    while(receiveRunning){
        ...
        switch(msg.code){
            ...
            case PULSE_LOW_HIGH_MACHINE1:
                switch (msg.value.sival_int){
                    ...
                    case BUTTON_START:
                        ...
                        break;
                    case BUTTON_RESET:
                        errorFsm.reset_pressed(); //TODO: muss geändert werden in anlage 2
                        break;
                    case LBB:
                        if(inOperation){
            ...
            case PULSE_HIGH_LOW_MACHINE1:
                switch (msg.value.sival_int) {
                    ...
                    case LBB:
                        ...
                        if(inOperation){
                            beginFsm.m1_lbb_blocked(); // TODO: change 1 to 2 in A2
                        }
                        break;
                    case LBS:
           ...
           case PULSE_HIGHT:
               if(inOperation){
                  // printf("hightchanged from fsm thread\n");
