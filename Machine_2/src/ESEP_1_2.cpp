...
int main(int argc, char** args) {
    ...
    int channelID_Wathcdog = myCreateChannel();
    ...
    int connectionID_Watchdog = myConnectAttach(channelID_Wathcdog);
    ...
    thread watchdog = thread(&heartbeatFromMaster, connectionID_FSM);
